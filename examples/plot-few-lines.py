...
viewer1d.add_line(np.c_[x + 0.25, 1 + np.sin(2 * np.pi * x)], name="Sin", color="#FF0000", label="Sin")
viewer1d.add_line(np.c_[x + 0.25, 1 + np.cos(2 * np.pi * x)], name="Cos", color="#0000FF", label="Cos")
