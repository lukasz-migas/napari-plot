...
window = 0.2
layer_sin = viewer1d.add_scatter(np.c_[np.sin(2 * np.pi * x), x], name="Sin", face_color="magenta")
layer_cos = viewer1d.add_scatter(np.c_[np.cos(2 * np.pi * x), x], name="Cos", face_color="springgreen")
run_update()
