...
from napari_plot._app_model.actions._layerlist_context_actions import (
...
class NapariPlotApplication(Application):
...
def _napari_names() -> dict[str, object]:
    ...
    import napari_plot
    from napari_plot import components, layers, viewer
...
def get_app_model() -> NapariPlotApplication:
    """Get the Napari Application singleton."""
    return NapariPlotApplication.get_app_model()
